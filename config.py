...
DEFAULT_FROM = "noreply@kodfabrik.com"
...
SMTP_USER = 'noreply@kodfabrik.com'  # for SMTP AUTH, set SMTP username here
SMTP_PASS = '24676D5a'  # for SMTP AUTH, set SMTP password here
